...
test.describe("Role-Based Access Control", () => {
  test.describe("Admin Access", () => {
    test.beforeEach(async ({ page }) => {
      await page.goto("/");
      await page.fill('input[name="email"]', "supratim.admin@gmail.com");
  ...
  test.describe("Employee Access", () => {
    test.beforeEach(async ({ page }) => {
      await page.goto("/");
      await page.fill('input[name="email"]', "Aashish@gmail.com");
      await page.fill('input[name="password"]', "Aashish123");
      await page.click('button[type="submit"]');
      await expect(page).toHaveURL("/dashboard");
    });
...
test.describe("Error Handling and Edge Cases", () => {
  ...
  test("should handle concurrent user actions", async ({ page, context }) => {
    ...
    await page2.goto("/");
    await page2.fill('input[name="email"]', "Aashish@gmail.com");
    await page2.fill('input[name="password"]', "Aashish123");
